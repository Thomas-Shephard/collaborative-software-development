...
public class UpdateLecturerControllerTests
{
    ...
    {
        const int userId = 1;
        UpdateLecturerRequestModel request = new() { Email = "test@example.com", Name = "Test", IsAdmin = false };
    ...
    {
        const int userId = 1;
        UpdateLecturerRequestModel request = new() { Email = "other@example.com", Name = "Test", IsAdmin = false };
    ...
    {
        const int userId = 1;
        UpdateLecturerRequestModel request = new() { Email = "new@example.com", Name = "New Name", IsAdmin = true };
        ...
        _userRepositoryMock.Verify(repo => repo.UpdateUserAsync(It.Is<Core.Models.Lecturer>(l => l.Email == request.Email && l.Name == request.Name)), Times.Once);
    ...
    public async Task UpdateLecturer_InvalidModel_ReturnsBadRequest()
    {
        ...
        UpdateLecturerRequestModel request = new() { Email = "bad", Name = "Name", IsAdmin = false };
